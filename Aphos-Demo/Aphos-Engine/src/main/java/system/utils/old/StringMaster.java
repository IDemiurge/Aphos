...
import static system.consts.Strings.CONTAINER_SEPARATOR;
import static system.consts.Strings.NEW_LINE;
import static system.utils.old.RandomWizard.getVarPartLast;
...
public class StringMaster {
    ...
    public static Integer getWeight(String string, boolean inverse) {
        ...
        return NumberUtils.getInt(StringMaster.cropParenthesises(getVarPartLast(string)));
    }

    public static String getWeightItem(String string, boolean inverse) {
        if (inverse) {
            return getVarPartLast(string);
        }
        return string.replace(getVarPartLast(string), "");
    }
